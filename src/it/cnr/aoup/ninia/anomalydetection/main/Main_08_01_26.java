...
public class Main_08_01_26 {
	...
	public static void main(String[] args) throws Exception {
		...
		int f1 = ep_1;
		int f2 = ep_2;
		//String features = "F0,F1,F2,F3,F4,F5,F6,F7,F24,F25";
		//String features = "F0,F1,F2,F3,F4,F5,F6,F7,F8,F9,F10,F11,F12,F13,F14,F15,F24,F25,F26,F27";
		String features = "";
	...
	static double calcAccuracy(File lab1, File lab2) throws Exception {
		...
		System.out.println(((int)(accuracy*100d)/100d)+"\t"+TP+"\t"+TN+"\t"+FP+"\t"+FN);
